...
# sources
doc.addSource(path="sources/1-drawings/Lexend-Regular.ufo", name="Lexend-Regular.ufo", location=dict(wght=0, wdth=0, opsz=0), styleName="Regular", familyName=familyName, copyLib=False, copyGroups=False, copyInfo=False, copyFeatures=False, muteKerning=False, muteInfo=False, mutedGlyphNames=None)
...
sources = [
	dict(path="master_ufo/Lexend-Regular.ufo", name="Lexend-Regular.ufo", location=dict( wght=400), styleName="Regular", familyName=familyName, copyInfo=True),
	
##	Main 
	dict(path="master_ufo/Lexend-wght300.ufo", name="Lexend-wght300.ufo", location=dict(wght=300), styleName="wght300", familyName=familyName, copyInfo=False),
	dict(path="master_ufo/Lexend-wght700.ufo", name="Lexend-wght700.ufo", location=dict(wght=700), styleName="wght900", familyName=familyName, copyInfo=False),
]
#instances = []
axes = [
	
	dict(minimum=300, maximum=700, default=400, name="wght", tag="wght", labelNames={"en": "wght"}, map=[]),
